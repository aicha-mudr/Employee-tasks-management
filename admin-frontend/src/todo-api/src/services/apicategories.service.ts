...
class ApicategoriesService extends __BaseService {
   ...
   */
  updateCategoryResponse(body: EmployeDto): __Observable<__StrictHttpResponse<EmployeDto>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
   ...
   * @return successful operation
   */
  updateCategory(body: EmployeDto): __Observable<EmployeDto> {
   ...
   */
  getAllCategoriesByAdminIdResponse(id: number): __Observable<__StrictHttpResponse<Array<EmployeDto>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    if (id != null) __params = __params.set('id', id.toString());
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/categories/admins/${id}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return List of the categories
   */
  getAllCategoriesByUserId(id: number): __Observable<Array<EmployeDto>> {
    return this.getAllCategoriesByAdminIdResponse(id).pipe(
   ...
   * @return The Category
   */
  getCategoryResponse(id: number): __Observable<__StrictHttpResponse<EmployeDto>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    if (id != null) __params = __params.set('id', id.toString());
   ...
   * @return The Category
   */
  getCategory(id: number): __Observable<EmployeDto> {
